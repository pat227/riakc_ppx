...
module IntBytes_jsonclass_versioned = Cache_classes.Make(Int_json_capable)(Bytes_json_capable_versioned)
module IntBool_jsonclass =           Cache_classes.Make(Int_json_capable)(Bool_json_capable)
module IntBool_jsonclass_versioned = Cache_classes.Make(Int_json_capable)(Bool_json_capable_versioned)
module String_jsonclass =           Cache_classes.Make(String_json_capable)(String_json_capable)
module String_jsonclass_versioned = Cache_classes.Make(String_json_capable)(String_json_capable_versioned)
module StringBool_jsonclass =           Cache_classes.Make(String_json_capable)(Bool_json_capable)
module StringBool_jsonclass_versioned = Cache_classes.Make(String_json_capable)(Bool_json_capable_versioned)
module StringIntCache_jsonclass =           Cache_classes.Make(String_json_capable)(Int_json_capable)
module StringIntCache_jsonclass_versioned = Cache_classes.Make(String_json_capable)(Int_json_capable_versioned)
